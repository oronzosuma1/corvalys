                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="color: #1B3A5C; margin: 0 0 20px; font-size: 20px;">Your Proposal from Corvalys</h2>
                            ...
                            <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 15px;">
                                Thank you for your interest in Corvalys. Following our analysis of your project requirements, we have prepared a detailed proposal for your review.
                            </p>

                            <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 15px;">
                                Please find the proposal document attached to this email. It includes a summary of our assessment, proposed services, cost estimates, and projected timeline.
                            </p>

                            <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 25px;">
                                We would be happy to schedule a call to walk you through the proposal and answer any questions you may have.
                            </p>
