...
@section('content')
    ...
    <div class="bg-white rounded-xl border border-gray-200/60 overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100">
            <h2 class="text-sm font-heading font-semibold text-gray-900">Crea nuova pagina</h2>
        </div>
        <form method="POST" action="{{ route('admin.pages.store') }}" class="p-5">
            @csrf
            <div class="space-y-5">
                {{-- Title --}}
                <div>
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="2"
                        class="w-full rounded-lg border-gray-300 text-sm focus:border-primary focus:ring-primary resize-none @error('meta_description') border-red-300 @enderror">{{ old('meta_description') }}</textarea>
