            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="body" id="body" rows="16" required
                        class="w-full rounded-lg border-gray-300 text-sm font-mono focus:border-primary focus:ring-primary @error('body') border-red-300 @enderror">{{ old('body', $page->body) }}</textarea>
                    @error('body')
                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                </div>
