...
@section('title', __('about.mission.meta.title', [], app()->getLocale()) ?: 'La Nostra Missione — Corvalys')
@section('meta_description', __('about.mission.meta.description', [], app()->getLocale()) ?: '')
