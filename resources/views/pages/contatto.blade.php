...
@section('title', 'Contact — Corvalys')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2">
                <form method="POST" action="{{ route('contatto.store') }}" @submit.prevent="submitForm" x-ref="form">
                    @csrf
                            ...
                            <div class="bg-white rounded-xl border border-gray-200 p-6">
                                <label class="flex items-start gap-3 cursor-pointer">
                                    ...
                                    <span class="text-sm text-gray-600" data-i18n-html="contact.gdpr">
                                        ...
                                        <a href="{{ route('privacy') }}" class="text-primary hover:underline" target="_blank">Privacy Policy</a> <span class="text-red-400">*</span>
                                    </span>
                                </label>
            ...
            {{-- ===== Right column -- Sidebar (visible steps 1-3) ===== --}}
            <aside x-show="step < 4" x-transition class="space-y-6 lg:sticky lg:top-24 lg:self-start">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    ...
                    <a href="{{ config('corvalys.calendly_url') }}" target="_blank" rel="noopener"
...
function contactForm() {
    return {
        ...
        form: {
            ...
            current_ai_usage: '{{ old("current_ai_usage", "none") }}',
            // Step 3
